...
class Cnn(object):
    ...
    def build_model(self) -> None:
        ...
        self.model.add(layers.Conv2D(
            6, (5, 5), padding='SAME', activation='sigmoid', input_shape=(20, 20, 1)
        ))
    ...
    def save_model(self, model_path='./model/model.h5') -> None:
        print('保存模型...')
        self.model.save(model_path)

    def load_model(self, model_path='./model/model.h5') -> None:
        print('读取模型...')
