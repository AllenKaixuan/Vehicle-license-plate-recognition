...
class Predict:
    def load_data(self):
        ...
        resized_image = cv.resize(gray_image, (IMAGE_HEIGHT, IMAGE_WIDTH))  # reshape时宽和高的顺序？
    ...
    def load_model(self, model_path=cnn.MODEL_PATH):
        print('load model...')
    ...
    def predict(self):
        ...
        prediction_results = ([k for k,v in cnn.LABEL_DICT.items() if v==prediction_index])
